<div class="row">
    ...
    <div class="col-12 col-md-6">
        <div class="infomain bd-1 text-bg-light bd-danger shadow-md mb-2 text-center">
            <div>
                A <span class="text-danger fw-bold">Exclusão</span> da agência irá finalizar a agência definitivamente.
                <br>
            ...
            <button class="btn btn-sm btn-danger mt-4 mb-2" data-eb-rmv="upg/agencia/encerrar/<?= $URI[1]; ?>/<?= Token('get'); ?>"><i class="bi bi-house-lock-fill me-1"></i> Excluir Agência</button>
        </div>
    </div>
</div>